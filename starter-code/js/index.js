...
// table
  ...
  // variavel unit foi pra dentro da funcao para atualizar o valor
...
// pesquisar bubbling (pq o false);

// click event on CREATE btn 
...
let curentProduct = event.target.parentNode.parentNode;
table.removeChild(curentProduct);
